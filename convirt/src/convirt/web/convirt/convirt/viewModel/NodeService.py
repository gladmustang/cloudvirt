...
#                self.manager.migrateDomains(auth,managed_node, vm_list, dest_node, True, isForce)
    ...
    def qcow2_snapshot_delete(self, auth,dom_id=None,node_id=None, snapshot_tag=None):
        return self.manager.qcow2_snapshot_delete(auth, dom_id, node_id,snapshot_tag)
